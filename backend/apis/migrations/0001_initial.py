# Generated by Django 5.1.1 on 2024-11-05 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ImageField(upload_to=apis.models.business_image_upload_to)),
                ('work_time', models.JSONField(default=apis.models.default_work_time)),
            ],
        ),
        migrations.CreateModel(
            name='Users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_1', models.ImageField(blank=True, null=True, upload_to=apis.models.business_image_upload_to)),
                ('image_2', models.ImageField(blank=True, null=True, upload_to=apis.models.business_image_upload_to)),
                ('image_3', models.ImageField(blank=True, null=True, upload_to=apis.models.business_image_upload_to)),
                ('image_4', models.ImageField(blank=True, null=True, upload_to=apis.models.business_image_upload_to)),
